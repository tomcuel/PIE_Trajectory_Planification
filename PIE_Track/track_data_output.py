...
for i, (alt, utmx, utmy, longx, longy) in enumerate(path_points):
    path_points[i] = (alt, utmx + utmx_median, utmy + utmy_median, longx + longx_median, longy + longy_median)
...
departure_radius = 8
plt.scatter(start_point[3], start_point[4], color='green', s=departure_radius**2, label="Start", edgecolors='black', zorder=5)
# bigger red circle for the vehicle
vehicle_radius = 8
plt.scatter(goal_point[3], goal_point[4], color='red', s=vehicle_radius**2, label="Goal", edgecolors='black', zorder=5)
